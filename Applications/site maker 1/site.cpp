...
void set_file ()
{
	...
	fo << get_maker_file( "maker files/site_1" );
	fo << upper( filename );
	fo << get_maker_file( "maker files/site_2" );
	fo << upper( filename );
	fo << get_maker_file( "maker files/site_3" );
	...
	fo << get_maker_file( "maker files/site_4" );

	fo << upper( filename );

	fo << get_maker_file( "maker files/site_5" );
