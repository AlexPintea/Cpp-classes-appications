...
string parameters[4] = { "parameter", "parameter2[10]", "parameter1[10][10][10][10][10]" };
string columns[4] = { "parameter", "parameter2[10]", "parameter1[10][10][10][10][10]" };
string types[4] = { "int", "float", "bool" };

class Item {

	// "Item" has parameters: parameter, parameter2[10], parameter1[10][10][10][10][10] 
	...
	bool parameter1[10][10][10][10][10];
	bool parameter1_data[10];
  ...
  public:
	...
	void set_parameter1_to_its_data ( bool parameter1_data[], bool parameter1[][10][10][10][10] )
	{
		int i = 0;
	...
	bool get_parameter1_data( int i ) // get parameter1_data[i]
	{
		...
		{
			cout << "\n(get) Item at '" << i << "' ("<< i+1 << "-th) is not available in 'parameter1[10][10][10][10][10]'. Its size is '" << parameter1_count << "'. 0 was returned.\n";
			return 0;
		}
	}
	...
	void set_parameter1_data( bool data[] ) { copy( data, this->parameter1_data ); this->is_empty = false;  };
	void set_parameter1_data( bool data, int i ) // set parameter1[i] to data
	{
		if ( i < parameter1_count and i >= 0 )
			parameter1_data[i] = data;
		else
		{
			cout << "\n(set) Item at '" << i << "' ("<< i+1 << "-th) is not available in 'parameter1[10][10][10][10][10]'. Its size is '" << parameter1_count << "'. It was not modified.\n";
		}
	}
	...
	void info()
	{
		...
		cout << "	bool" << ' ' << "parameter1[10][10][10][10][10] = { ";
