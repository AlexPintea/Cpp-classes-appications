...
void edit_class_file()
{
	...
	string command_file = "./" + entry_file;
...
void delete_class_file()
{
	...
	if ( sure == "y" )
	{
		string command_delete = "rm -R " + entry_file + " && rm -R " + entry_file + "_entries";
		command( command_delete );
		cout << "Files: \'" << entry_file << "\' and \'" << entry_file << "_entries\' were deleted.\n";

		entry_files_strings[ choice - 1 ] = "";
...
//	file << "		}\n";
	...
	string command_compile = "g++ -o " + name + " " + name + ".cpp && rm -R " + name + ".cpp";
