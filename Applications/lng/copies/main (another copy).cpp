...
// needed to have whitespace around them - not used
...
void insert_char ( string &a, int pos, char insert )
{
	int size = a.length();
...
void remove_enter ( string &a )
{
	...
	for ( int i = 0; i < size; i = i + 1 )
		if ( has_at_pos( a, i, "include" ) and i != 0 )
		{
...
int main ()
{
	...
	add_main( data_path + '/' + filename + ".cpp" );
