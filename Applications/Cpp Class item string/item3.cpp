...
class Item3 {
	...
	// "Item3" has parameters: parameter, parameter2[10], parameter1 
...
//		copy( {}, this->parameter2 ); // You edit this
	...
	char get_parameter1() { return this->parameter1; };
	...
	void set_parameter1( char data ) { this->parameter1 = data; this->is_empty = false;  };
	...
	void info()
	{
		...
		cout << "	char" << ' ' << "parameter1 = " << parameter1 << '\n';
	 	cout << '}' << "\n\n";
	}
...
Item3 item_entries[10000]; // entries
int iter = 0;
...
Item3 make_entry ()
{
	...
	cout << "Enter val. for \'parameter1\' of type \'char\': ";

	char temp_char_2;

	cin >> temp_char_2;
	entry.set_parameter1( temp_char_2 );
...
void get_entries()
{
	...
	for ( int i=0; i<iter; i=i+1 )
	{
		...
		entries >> temp_char_2;
		item_entries[i].set_parameter1( temp_char_2 );
	}
...
// Get entry item - for "char" datatype
void get_entry_item( char item )
{
	for ( int i=0; i<iter; i=i+1 )
	...
	for ( int i=0; i<100000; i=i+1 )
	{
		...
		if ( choice == "item" )
		{
			...
			else
			{
				...
				get_entry_item( item_parameter[0] );
			}
